  ...
  return (
    <>
      ...
      <main className="left-gap">
        <Hero title="Privacy Policy" subtitle="Number One in Split Rail Fence" textContent="" bottomText="Serving PA, NJ, DE, MD and Surrounding Areas"  />
        <div className="" style={{padding:'30px'}}>
          ...
          <ul className="list-none">
            <li>We do not collect information from visitors of our site.</li>            
          </ul>
          <p>When do we collect information?</p>
          <ul className="list-none">
            <li>We collect information from you when you or enter information on our site.</li>            
          </ul>
          <p>How do we use your information?</p>
          <ul className="list-none">
            <li>We may use the information we collect from you when you register, make a purchase, sign up for our newsletter, respond to a survey or marketing communication, surf the website, or use certain other site features in the following ways:</li>            
          </ul>
          ...
          <ul className="list-none">
            <li>Yes. Cookies are small files that a site or its service provider transfers to your computer&apos;s hard drive through your Web browser (if you allow) that enables the site&apos;s or service provider&apos;s systems to recognize your browser and capture and remember certain information. For instance, we use cookies to help us remember and process the items in your shopping cart. They are also used to help us understand your preferences based on previous or current site activity, which enables us to provide you with improved services. We also use cookies to help us compile aggregate data about site traffic and site interaction so that we can offer better site experiences and tools in the future.</li>
          </ul>
          ...
          <p><em>Google</em></p>
          <p style={{ wordBreak:'break-all'}}>Google&apos;s advertising requirements can be summed up by Google&apos;s Advertising Principles. They are put in place to provide a positive experience for users. https://support.google.com/adwordspolicy/answer/1316548?hl=en</p>
          ...
          <ul className="list-none">
            ...
            <li>
              <ul>
                <li>On our Privacy Policy Page - Users are able to change their personal information:</li>
          ...
          <p>It&apos;s also important to note that we allow third party behavioral tracking COPPA (Children Online Privacy Protection Act).</p>
