  ...
  return (
    <>
      ...
      <main className="left-gap">
        <Hero title="Terms and Conditions" subtitle="Number One in Split Rail Fence" textContent="" bottomText="Serving PA, NJ, DE, MD and surrounding areas"  />
        <div className="" style={{padding:'30px'}}>
          ...
          <p>We are committed to protecting your privacy. Authorized employees within the company on a need to know basis only use any information collected from individual customers. We constantly review our systems and data to ensure the best possible service to our customers. Parliament has created specific offences for unauthorized actions against computer systems and data. We will investigate any such actions with a view to prosecuting and/or taking civil proceedings to recover damages against those responsible.</p>
          ...
          <p><b>Disclaimer</b></p>
          <p>Exclusions and Limitations The information on this web site is provided on an “as is” basis. To the fullest extent permitted by law, this Company:</p>
...
This Company does not however exclude liability for death or personal injury caused by its negligence. The above exclusions and limitations apply only to the extent permitted by law. None of your statutory rights as a consumer are affected.</p>
          ...
          <p><b>Payment</b></p>
          <p>Cash or Personal Check, all major Credit/Debit Cards.</p>
          <p>Returned checks will incur a $25 charge to cover banking fees and administrative costs. In an instance of a second Returned check, we reserve the right to terminate the arrangement and shall insist on future cash transactions only. Consequently, transactions and agreements entered into will cease with immediate effect until such time as any and all outstanding monies are recovered in full.</p>

          <p><b>Cancellation Policy</b></p>
          <p>Minimum 24 hours notice of cancellation required. Notification for instance, in person, via email, and/or fax, or any other means will be accepted subject to confirmation in writing. We reserve the right to levy a $50 charge to cover any subsequent administrative expenses.</p>

          <p><b>Termination of Agreements and Refunds Policy</b></p>
          ...
          <p>This company is registered in:<br />4619 County Line Road<br />Line Lexington PA 18932</p>
          ...
          <p><b>© Split Rail Fence Store 2016 All Rights Reserved.</b></p>
